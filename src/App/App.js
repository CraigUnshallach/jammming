...
function App() {
  ...
  const savePlaylist = useCallback(async () => {
    try {
      ...
      setSavedStatus('The playlist was successfully saved.');
      ...
      setSavedStatus('Playlist was not saved. An error occurred.');
  ...
  return (
    <div>
      <h1>Gr<span className="highlight">oo</span>veGlider</h1>
      <div className="App">
        <br></br>
